        ...
        <div class="row">
          ...
          <div class="col-xl-9 col-lg-12">
            <div class="filters-wrap">
              ...
              <div v-if="getSignedBooks && getSignedBooks[0] && getSignedBooks[0].data">
                <transition-group
                ...
                >
                  <div
                    v-for="(product, i) in getSignedBooks[0].data"
                  ...
                  <badge v-if="getSignedBooks" :price="product.price" :stockStatus="product.stock_status" :stockLeft="product.only_x_left_in_stock" :latest="getHomeLatest" :product="product.product_id"></badge>
                  <button class="linked-for-detailpage" @click="redirectToDetailPage(product)" ></button>
                    ...
                    <div class="category-details">
                      <div class="category-left">
                        ...
                        <div class="category-info" v-if="product.author_name!==false">
                          {{ product.author_name }}
                        </div>
